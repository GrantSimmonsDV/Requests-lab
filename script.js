...
// CODE HERE
document.querySelector("#say-hello-button").addEventListener("click", sayHello)
...
// const repeatMyParam = ()  => {
//     //YOUR CODE HERE
//     axios.get('http://localhost:3000/repeat/YohoMatey')
//         .then((res) => {
...
document.querySelector("#query-button").addEventListener("click", () => {
    axios.get('http://localhost:3000/query-test?name=grant')
        .then((res) => {
            console.log(res.data)
        })
})
